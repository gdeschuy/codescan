...
node{
    ...
    stage('Analyse Code'){
        ...
        def cpdOutput = bat returnStdout: true, script: "$CPD_TOOL --minimum-tokens 10 --files $PROJECT_DIR/classes --language apex --encoding UTF-8 --format txt --failOnViolation false";
        if(cpdOutput) {            
